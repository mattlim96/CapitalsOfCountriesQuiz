...
public class MPQuestionList extends AppCompatActivity {

    private Button p1Finished;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mpQ1TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ1Page.MPQ1Answered){
                    Intent mpq1 = new Intent(MPQuestionList.this, MPQ1Page.class);
                    startActivity(mpq1);
                } else {
        ...
        mpQ2TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ2Page.MPQ2Answered){
                    Intent spq2 = new Intent(MPQuestionList.this, MPQ2Page.class);
                    startActivity(spq2);
                } else {
        ...
        mpQ3TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ3Page.MPQ3Answered){
                    Intent spq3 = new Intent(MPQuestionList.this, MPQ3Page.class);
                    startActivity(spq3);
                } else {
        ...
        mpQ4TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ4Page.MPQ4Answered){
                    Intent spq4 = new Intent(MPQuestionList.this, MPQ4Page.class);
                    startActivity(spq4);
                } else {
        ...
        mpQ5TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ5Page.MPQ5Answered){
                    Intent spq5 = new Intent(MPQuestionList.this, MPQ5Page.class);
                    startActivity(spq5);
                } else {
        ...
        mpQ6TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ6Page.MPQ6Answered){
                    Intent spq6 = new Intent(MPQuestionList.this, MPQ6Page.class);
                    startActivity(spq6);
                } else {
        ...
        mpQ7TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ7Page.MPQ7Answered){
                    Intent spq7 = new Intent(MPQuestionList.this, MPQ7Page.class);
                    startActivity(spq7);
                } else {
        ...
        mpQ8TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ8Page.MPQ8Answered){
                    Intent spq8 = new Intent(MPQuestionList.this, MPQ8Page.class);
                    startActivity(spq8);
                } else {
        ...
        mpQ9TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ9Page.MPQ9Answered){
                    Intent spq9 = new Intent(MPQuestionList.this, MPQ9Page.class);
                    startActivity(spq9);
                } else {
        ...
        mpQ10TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MPQ10Page.MPQ10Answered){
                    Intent spq10 = new Intent(MPQuestionList.this, MPQ10Page.class);
                    startActivity(spq10);
                } else {
        ...
        /**
         *  Do this on Finish button in Player 1 Question List page.
         */
        p1Finished.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){

                // Creates an Intent object from current page to Player 2 start page.
                Intent toP2start = new Intent(MPQuestionList.this, MP_P1_Transition.class);

                // Execute Intent object.
                startActivity(toP2start);
